...
p3a <- newdata %>%
  ...
  # we compute the posterior difference (we add the mean of the low category, just to align things when plotting)
  ...
  geom_hline(yintercept = mean(invlogit(newdata$post_act_ifres)), lty = 2, col = "darkgrey") + ## the reference line for the difference
